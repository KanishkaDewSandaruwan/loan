    ...
    <div class="content">
        <div class="py-4 px-3 px-md-4">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                ...
                <div class="h3 mb-0"><button class="btn btn-lg btn-primary" type="button" data-toggle="modal" data-target="#exampleModal" >Add New</button></div>
            </div>
                ...
                <div class="col-12">
                    <div class="card mb-3 mb-md-4">
                        <div class="card-header">
                            <h5 class="font-weight-semi-bold mb-0">Members List</h5>
                        </div>
                            ...
                            <div class="table-responsive-xl">
                                <table class="table text-nowrap mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="font-weight-semi-bold border-top-0 py-2">NIC</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3"><?php echo $row['phone']; ?></td>
                                        <td class="py-3"><?php echo $row['address']; ?></td>
                                        <td class="py-3"><?php echo $row['email']; ?></td>
                                        <td class="py-3"><?php echo $row['nic']; ?></td>
                                        <td class="py-3"><?php echo $row['reg_date']; ?></td>
                                        <td class="py-3">
