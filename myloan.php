    ...
    <main>
        ...
        <section class="contact-section">
            <div class="container-fluid">
              <div class="row">
                  <div class="col-md-8">
                    <h1>My Loan Details</h1> 
                  </div>
                  <div class="col-md-2">
                    <button class="btn btn-danger btn-lg" onclick="window.location.href ='history.php' ">Completed Loan</button>
                  </div>
                  <div class="col-md-2">
                    <button class="btn btn-danger btn-lg" onclick="window.location.href ='cancel_list.php'">Canceled Loan</button>
                  </div>
                </div>
            ...
            $row4 = mysqli_fetch_assoc($viewresult4);
            if ($row4['status'] == 'Pending' || $row4['status'] == 'Accepted' ) { 
            ...
            <div class="row">
                        <div class="col-md-4">
                          ...
                          <?php $member_id = $_SESSION['member_id'];
                                ...
                                $viewquery1 = " SELECT * FROM loan where loan_id = '$loan_id'";
                                $viewresult1 = mysqli_query($con,$viewquery1);
                                $row1 = mysqli_fetch_assoc($viewresult1);

                                $bank_image = $row1['signature_image'];
                            ...
                            <div class="row p-3 mt-5"><span style="font-size: 25px; font-weight: bold;">Current Loan Balance : </span> <span style="font-size: 25px; font-weight: bold; color: red; margin-left: 15px;"><?php echo $row1['current_balance'] ?></span></div>
                            <div class="row p-3">
                            ...
                            <div class="row p-3"><span>Loan Amount : </span> <span><?php echo $row1['loan_amount'] ?></span></div>
                            <div class="row p-3"><span>Work Station Address : </span> <span><?php echo $row2['station_address'] ?></span></div>
                            <div class="row p-3"><span>PaySheet : </span> <span><?php echo $row1['paysheet']; ?>  <a class="text-danger" href="download_paysheet.php?file_id=<?php echo $row1['loan_id'] ?>">Download</a></h6></div>

                            <div class="row p-3"><span>Application : </span><h6><?php echo $row1['document']; ?> <a class="text-danger" href="download.php?file_id=<?php echo $row1['loan_id'] ?>">Download</a></h6> <span></div>
                            <div class="row p-3"><span>Status : </span> <span><?php echo $row1['status'] ?></span></div>
                            <div class="row p-3"><img style="width: 300px; margin-top: 10px;" src="<?php echo $image_src1; ?>" alt=""></div>
                            <?php if ($row1['status'] == 'Pending') {?>
                            <div class="row p-3"><div class="dropdown show">
                                <a class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  Action
                                </a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                  <a class="dropdown-item" href="edit_loan.php?loan_id=<?php echo $row1['loan_id']; ?>">Edit Loan</a>
                                  <a class="dropdown-item" href="cancel.php?loan_id=<?php echo $row1['loan_id']; ?>">Cancel Loan</a>
                                </div>
                              </div></div>
                                <?php } ?>
                        </div>
                        <div class="col-md-4" style="margin-top: 12%;">
                            <div class="row p-3"><span>Number of Month : </span> <span> <?php echo $row1['number_of_months'] ?></span></div>
                          <div class="row p-3"><span>Monthly  : </span> <span><?php echo $row1['monthly_amount'] ?></span></div>
                            <div class="row p-3">
                                <span>Number of Paid Month : </span> <span><?php echo $row1['number_of_paid'] ?></span>
                            </div>
                        </div>
